...
public class HfpClientMainActivity extends Activity implements View.OnClickListener{
    ...
    private void bluetoothSetupPostProcess() {
        ...
        currentBatteryCharge = 1;
        isVibrating = false;
        tv_device1Name = (TextView)findViewById(R.id.device1name);
        tv_displayState1 = (TextView)findViewById(R.id.titletext);
        tv_displayNumber1 = (TextView)findViewById(R.id.displaynumber);
        tv_device2Name = (TextView)findViewById(R.id.device2name);
        tv_displayState2 = (TextView)findViewById(R.id.titletext2);
        tv_displayNumber2 = (TextView)findViewById(R.id.displaynumber2);
        et_numberEntry = (EditText)findViewById(R.id.edittext);
        b_hfButton = (ToggleButton)findViewById(R.id.disconnect_button);
        b_redial = (Button)findViewById(R.id.redial_button);
        b_dial = (Button)findViewById(R.id.dial_button);
        b_endCall = (Button)findViewById(R.id.endcall_button);
        ...
        b_callControl = (Button)findViewById(R.id.call_control);
        b_enhancedCallControl = (Button)findViewById(R.id.enhanced_call_control);
        b_vrControl = (ToggleButton)findViewById(R.id.vr_button);
        b_swapUiButton = (Button)findViewById(R.id.swap_ui_button);
